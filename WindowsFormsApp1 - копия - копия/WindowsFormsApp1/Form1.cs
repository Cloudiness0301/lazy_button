...
namespace LazyButton
{
    public partial class Form1 : MetroForm //"Form" было изначально, а не "MetroForm"
    {
        ...
        //
        //
        // Собственно глобальный хук клавы
        ...
        {
            if (UserButtonTextBox.Text == "")
            {
                MetroFramework.MetroMessageBox.Show(this, "Пожалуйста введите желаемую клавишу(их комбинацию) или выберете другое действие",
        ...
        {            
            ...
            if (e.Control)
            {
                CheckTextBox.Text += "Ctrl+";
            }
            // проверяем нажата ли клавиша Shift: если да, то записаваем в поле слово Shift
            if (e.Shift)
            {
                CheckTextBox.Text += "Shift+";
            }
            // проверяем нажата ли клавиша Alt: если да, то записаваем в поле слово Alt
            if (e.Alt)
            {
                CheckTextBox.Text += "Alt+";
            }
            // копируем KeyData нажатой клавиши
            Keys key = e.KeyData;
            // извлекаем из данных о нажатой клавише коды системных кнопок, таких как Ctrl, Shift, Alt
            ...
            key &= ~Keys.Alt;
            // выводим полученное словосочетание          
            CheckTextBox.Text += key.ToString();
            /*
             P.S.
             раньше вместо этого: CheckTextBox.Text == UserButtonTextBox.Text , в условии стояло это: (object)text).Equals((object)UserButtonTextBox.Text)
             для этого в самом начале Form1_KeyDown нужно прописать это:
             Keys key = e.KeyData;            
             KeysConverter converter = new KeysConverter();
             string text = converter.ConvertToString(e.KeyCode);
             но с CheckTextBox.Text == UserButtonTextBox.Text в этом нет нужды.
            */
            ...
            if (CheckTextBox.Text == UserButtonTextBox.Text && UserButtonButtonCancel.Enabled == true && GroupButtonsOut.Enabled == false) //e.KeyCode == SendKeys.Equals()
            {
                if (LaunchingTheProgramFileWayTextBox.Text == "")
                {
            ...
            // Проработал: исправил MouseFunctionComboBox.SelectedItem == "Щелчок" на MouseFunctionComboBox.SelectedIndex == 1, и остальные так же соответственно своим индексам.
            // 2) Реализация назначения Функции мыши.
            // Цикл запуска Щелчка мыши на нажание Num Multiply.
            if (MouseFunctionComboBox.SelectedIndex == 1 && e.KeyCode == Keys.Multiply && NumMultiplyButtonCancel.Enabled == true && GroupButtonsOut.Enabled == false)
            {               
                mouse_event(MouseEventF_LeftDown, 0, 0, 0, UIntPtr.Zero);
                mouse_event(MouseEventF_LeftUp, 0, 0, 0, UIntPtr.Zero);
            }
            // Цикл запуска Щелчка мыши на нажание Num Plus.
            if (MouseFunctionComboBox.SelectedIndex == 1 && e.KeyCode == Keys.Add && NumPlusButtonCancel.Enabled == true && GroupButtonsOut.Enabled == false)
            {
                mouse_event(MouseEventF_LeftDown, 0, 0, 0, UIntPtr.Zero);
                mouse_event(MouseEventF_LeftUp, 0, 0, 0, UIntPtr.Zero);
            }
            // Цикл запуска Щелчка мыши на нажание Num Minus.
            if (MouseFunctionComboBox.SelectedIndex == 1 && e.KeyCode == Keys.Subtract && NumMinusButtonCancel.Enabled == true && GroupButtonsOut.Enabled == false)
            {
                mouse_event(MouseEventF_LeftDown, 0, 0, 0, UIntPtr.Zero);
                mouse_event(MouseEventF_LeftUp, 0, 0, 0, UIntPtr.Zero);
            }
            // Цикл запуска Щелчка мыши на назначенную пользователем клавишу.
            if (MouseFunctionComboBox.SelectedIndex == 1 && CheckTextBox.Text == UserButtonTextBox.Text && UserButtonButtonCancel.Enabled == true && GroupButtonsOut.Enabled == false)
            {
                mouse_event(MouseEventF_LeftDown, 0, 0, 0, UIntPtr.Zero);
                mouse_event(MouseEventF_LeftUp, 0, 0, 0, UIntPtr.Zero);
            ...
            if (MouseFunctionComboBox.SelectedIndex == 2 && e.KeyCode == Keys.Multiply && NumMultiplyButtonCancel.Enabled == true && GroupButtonsOut.Enabled == false)
            {
                mouse_event(MouseEventF_LeftDown, 0, 0, 0, UIntPtr.Zero);
                mouse_event(MouseEventF_LeftUp, 0, 0, 0, UIntPtr.Zero);
                mouse_event(MouseEventF_LeftDown, 0, 0, 0, UIntPtr.Zero);
            ...
            if (MouseFunctionComboBox.SelectedIndex == 2 && e.KeyCode == Keys.Add && NumPlusButtonCancel.Enabled == true && GroupButtonsOut.Enabled == false)
            {
                mouse_event(MouseEventF_LeftDown, 0, 0, 0, UIntPtr.Zero);
                mouse_event(MouseEventF_LeftUp, 0, 0, 0, UIntPtr.Zero);
                mouse_event(MouseEventF_LeftDown, 0, 0, 0, UIntPtr.Zero);
            ...
            if (MouseFunctionComboBox.SelectedIndex == 2 && e.KeyCode == Keys.Subtract && NumMinusButtonCancel.Enabled == true && GroupButtonsOut.Enabled == false)
            {
                mouse_event(MouseEventF_LeftDown, 0, 0, 0, UIntPtr.Zero);
                mouse_event(MouseEventF_LeftUp, 0, 0, 0, UIntPtr.Zero);
                mouse_event(MouseEventF_LeftDown, 0, 0, 0, UIntPtr.Zero);
            ...
            if (MouseFunctionComboBox.SelectedIndex == 2 && CheckTextBox.Text == UserButtonTextBox.Text && UserButtonButtonCancel.Enabled == true && GroupButtonsOut.Enabled == false)
            {
                mouse_event(MouseEventF_LeftDown, 0, 0, 0, UIntPtr.Zero);
                mouse_event(MouseEventF_LeftUp, 0, 0, 0, UIntPtr.Zero);
                mouse_event(MouseEventF_LeftDown, 0, 0, 0, UIntPtr.Zero);
            ...
            if (MouseFunctionComboBox.SelectedIndex == 3 && e.KeyCode == Keys.Multiply && NumMultiplyButtonCancel.Enabled == true && GroupButtonsOut.Enabled == false)
            {
            ...
            if (MouseFunctionComboBox.SelectedIndex == 3 && e.KeyCode == Keys.Add && NumPlusButtonCancel.Enabled == true && GroupButtonsOut.Enabled == false)
            {
                mouse_event(MouseEventF_RightDown, 0, 0, 0, UIntPtr.Zero);
                mouse_event(MouseEventF_RightUp, 0, 0, 0, UIntPtr.Zero);
                mouse_event(MouseEventF_RightDown, 0, 0, 0, UIntPtr.Zero);
            ...
            if (MouseFunctionComboBox.SelectedIndex == 3 && e.KeyCode == Keys.Subtract && NumMinusButtonCancel.Enabled == true && GroupButtonsOut.Enabled == false)
            {
                mouse_event(MouseEventF_RightDown, 0, 0, 0, UIntPtr.Zero);
                mouse_event(MouseEventF_RightUp, 0, 0, 0, UIntPtr.Zero);
                mouse_event(MouseEventF_RightDown, 0, 0, 0, UIntPtr.Zero);
            ...
            if (MouseFunctionComboBox.SelectedIndex == 3 && CheckTextBox.Text == UserButtonTextBox.Text && UserButtonButtonCancel.Enabled == true && GroupButtonsOut.Enabled == false)
            {
                mouse_event(MouseEventF_RightDown, 0, 0, 0, UIntPtr.Zero);
                mouse_event(MouseEventF_RightUp, 0, 0, 0, UIntPtr.Zero);
                mouse_event(MouseEventF_RightDown, 0, 0, 0, UIntPtr.Zero);
            ...
            if (WINDOWSKeyCombinationComboBox.SelectedIndex == 1 && e.KeyCode == Keys.Multiply && NumMultiplyButtonCancel.Enabled == true && GroupButtonsOut.Enabled == false) //e.KeyCode == SendKeys.Equals()
            {
                LockWorkStation();
            }
            // Цикл запуска Сочетания клавиш Windows: "LockWorkStation" на нажатие Num Plus.
            if (WINDOWSKeyCombinationComboBox.SelectedIndex == 1 && e.KeyCode == Keys.Add && NumPlusButtonCancel.Enabled == true && GroupButtonsOut.Enabled == false) //e.KeyCode == SendKeys.Equals()
            {
                LockWorkStation();
            }
            // Цикл запуска Сочетания клавиш Windows: "LockWorkStation" на нажатие Num Minus.
            if (WINDOWSKeyCombinationComboBox.SelectedIndex == 1 && e.KeyCode == Keys.Subtract && NumMinusButtonCancel.Enabled == true && GroupButtonsOut.Enabled == false) //e.KeyCode == SendKeys.Equals()
            {
                LockWorkStation();
            }
            // Цикл запуска Сочетания клавиш Windows: "LockWorkStation" на назначенную пользователем клавишу.
            if (WINDOWSKeyCombinationComboBox.SelectedIndex == 1 && CheckTextBox.Text == UserButtonTextBox.Text && UserButtonButtonCancel.Enabled == true && GroupButtonsOut.Enabled == false) //e.KeyCode == SendKeys.Equals()
            {
                LockWorkStation();
            }
            // Цикл запуска Сочетания клавиш Windows: "Свернуть все окна" на нажатие Num Multiply.
            Shell32.Shell shell = new Shell32.Shell();
            if (WINDOWSKeyCombinationComboBox.SelectedIndex == 2 && e.KeyCode == Keys.Multiply && NumMultiplyButtonCancel.Enabled == true && GroupButtonsOut.Enabled == false) //e.KeyCode == SendKeys.Equals()
            {
                shell.MinimizeAll();
            }
            // Цикл запуска Сочетания клавиш Windows: "Свернуть все окна" на нажатие Num Plus.
            if (WINDOWSKeyCombinationComboBox.SelectedIndex == 2 && e.KeyCode == Keys.Add && NumPlusButtonCancel.Enabled == true && GroupButtonsOut.Enabled == false) //e.KeyCode == SendKeys.Equals()
            {
                shell.MinimizeAll();
            }
            // Цикл запуска Сочетания клавиш Windows: "Свернуть все окна" на нажатие Num Minus.
            if (WINDOWSKeyCombinationComboBox.SelectedIndex == 2 && e.KeyCode == Keys.Subtract && NumMinusButtonCancel.Enabled == true && GroupButtonsOut.Enabled == false) //e.KeyCode == SendKeys.Equals()
            {
                shell.MinimizeAll();
            }
            // Цикл запуска Сочетания клавиш Windows: "Свернуть все окна" на назначенную пользователем клавишу.
            if (WINDOWSKeyCombinationComboBox.SelectedIndex == 2 && CheckTextBox.Text == UserButtonTextBox.Text && UserButtonButtonCancel.Enabled == true && GroupButtonsOut.Enabled == false) //e.KeyCode == SendKeys.Equals()
            {
                shell.MinimizeAll();
            }
            // Цикл запуска Сочетания клавиш Windows: "Alt + TAB" на нажатие Num Multiply.
            if (WINDOWSKeyCombinationComboBox.SelectedIndex == 3 && e.KeyCode == Keys.Multiply && NumMultiplyButtonCancel.Enabled == true && GroupButtonsOut.Enabled == false) //e.KeyCode == SendKeys.Equals()
            {
                SendKeys.Send("%{TAB}");                
            }
            // Цикл запуска Сочетания клавиш Windows: "Alt + TAB" на нажатие Num Plus.
            if (WINDOWSKeyCombinationComboBox.SelectedIndex == 3 && e.KeyCode == Keys.Add && NumPlusButtonCancel.Enabled == true && GroupButtonsOut.Enabled == false) //e.KeyCode == SendKeys.Equals()
            {
                SendKeys.Send("%{TAB}");
            }
            // Цикл запуска Сочетания клавиш Windows: "Alt + TAB" на нажатие Num Minus.
            if (WINDOWSKeyCombinationComboBox.SelectedIndex == 3 && e.KeyCode == Keys.Subtract && NumMinusButtonCancel.Enabled == true && GroupButtonsOut.Enabled == false) //e.KeyCode == SendKeys.Equals()
            {
                SendKeys.Send("%{TAB}");
            }
            // Цикл запуска Сочетания клавиш Windows: "Alt + TAB" на назначенную пользователем клавишу.
            if (WINDOWSKeyCombinationComboBox.SelectedIndex == 3 && CheckTextBox.Text == UserButtonTextBox.Text && UserButtonButtonCancel.Enabled == true && GroupButtonsOut.Enabled == false) //e.KeyCode == SendKeys.Equals()
            {
                SendKeys.Send("%{TAB}");
            }            
            /*
